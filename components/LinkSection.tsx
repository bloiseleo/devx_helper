    ...
    return (
        <section className="w-full h-full p-4">
            <ul className="flex flex-wrap h-5/6 overflow-y-scroll">
                {links.map(link => (
                    <li key={link.anchor} className="ml-8 mt-8">
                        <div className="w-[200px] flex flex-col items-center border-[1px] dark:bg-[#222222] dark:border-none dark:text-white cursor-pointer rounded-lg p-4">
